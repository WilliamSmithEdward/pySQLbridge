...
INTERSECT, and 25 scalar functions. All 226 queries in
`scripts/differential.py` answer identically to SQL Server 2025. A subquery
...
| A subquery that reads the row around it | refused by name |
